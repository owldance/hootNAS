...
Wait_for_carrier ()
{
	live_debug_log "9990-select-eth-device.sh: Wait_for_carrier BEGIN"
	# $1 = network device
	...
	ip link set $1 down
	live_debug_log "9990-select-eth-device.sh: Wait_for_carrier END"
}

Select_eth_device ()
{
	live_debug_log "9990-select-eth-device.sh: Select_eth_device BEGIN"
