...
{
	local device probe backing old_backing fstype mount_opts mret
	device=${1}
	probe=${2}
...
close_persistence_media ()
{
	...
	live_debug_log "9990-misc-helpers.sh: close_persistence_media END"
}
...
probe_for_fs_label ()
{
	...
	overlays="${1}"
	dev="${2}"
	live_debug_log "9990-misc-helpers.sh: probe_for_fs_label BEGIN"
	...
	live_debug_log "9990-misc-helpers.sh: probe_for_fs_label END"
}
...
find_persistence_media ()
{
	...
	live_debug_log "9990-misc-helpers.sh: find_persistence_media END"
}
...
link_files ()
{
	live_debug_log "9990-misc-helpers.sh: link_files BEGIN"
...
get_custom_mounts ()
{
	...
	live_debug_log "9990-misc-helpers.sh: get_custom_mounts BEGIN"
	...
	live_debug_log "9990-misc-helpers.sh: get_custom_mounts END"
}
