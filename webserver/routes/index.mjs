...
apiRouter.post('/selectNfsExportsByUserId', checkAuthorization, shares.selectNfsExportsByUserId)
apiRouter.post('/createNetworkFileShare', checkAuthorization, shares.createNetworkFileShare)
apiRouter.post('/modifyNetworkFileShare', checkAuthorization, shares.modifyNetworkFileShare)
apiRouter.post('/removeNetworkFileShare', checkAuthorization, shares.removeNetworkFileShare)
